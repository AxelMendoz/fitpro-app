...
export default function EditRoutinePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [formData, setFormData] = useState({
    ...
    categoria: routine?.categoria || "Fuerza",
    duracion_estimada: routine?.duracion_estimada || 30,
  })
  const [selectedExercises, setSelectedExercises] = useState<number[]>(routine?.ejercicios || [])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("Rutina actualizada:", { id: routine.id, ...formData, ejercicios: selectedExercises })
    // Aquí implementarías la lógica para actualizar la rutina
  ...
  return (
    <div className="create-routine-page">
      ...
      <div className="form-container">
        <h1 className="form-title">Editar Rutina</h1>
        <p className="form-subtitle">Modifica los detalles y ejercicios de tu rutina</p>
